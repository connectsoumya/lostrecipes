...
function filterList() {
    ...
    t.length + e.length + n.length + r.length > 0 ? recipeList.filter(function (i) {
        var a = 0 === t.length || t.indexOf(i.values().category) > -1, s = 0 === e.length || e >= i.values().duration,
            o = 0 === n.length || n.filter(function (t) {
                return -1 !== i.values().tags.split(", ").indexOf(t)
            }).length > 0, l = 0 === r.length || r.filter(function (t) {
                return -1 !== i.values().tags.split(", ").indexOf(t)
            }).length > 0;
        return !!(a && s && o && l)
    }) : recipeList.filter()
...
!function (t, e) {
    ...
    return function (a, g) {
        ...
        O.cancelScroll = function (t) {
            ...
            O.cancelScroll();
            var s = r(p || e, a || {}), d = "[object Number]" === Object.prototype.toString.call(n),
            ...
            if (d || g) {
                ...
                var b, S, x, w = c(C),
                    ...
                    N = A - y, I = l(), L = 0, k = f(N, s), M = function (e, r) {
                        var a = t.pageYOffset;
        ...
        var x = function (e) {
            ...
            if (null !== history.state && history.state.smoothScroll && history.state.smoothScroll === JSON.stringify(p)) {
                ...
                e && 0 !== e && !(e = document.querySelector(s(history.state.anchor))) || O.animateScroll(e, null, {updateURL: !1})
            }
        };
...
var scroll = new SmoothScroll('a[href*="#"]', {easing: "easeInOutCubic", offset: 64}),
    menuOpen = document.getElementById("js-navOpen"), menuClose = document.getElementById("js-navClose"),
...
var List = function (t) {
        ...
        t.exports = function (t) {
            return function (e, n, r) {
                ...
                this.values = function (e, n) {
                    ...
                    if (void 0 === n) r ? i.values(e, r) : i.values(e); else {
                        i.elm = n;
        ...
        var r = (n(0), n(1)), i = n(7), a = n(6), s = n(3), o = n(19);
        t.exports = function (t, e) {
            e = e || {}, e = i({
                location: 0,
                distance: 100,
        ...
        var r = n(18), i = n(3), a = n(7), s = n(4), o = n(1), l = n(6), u = n(0), c = n(17), f = n(5);
        t.exports = function (t, e, d) {
            var h, m = this, v = n(2)(m), g = n(8)(m), p = n(12)(m);
            h = {
                start: function () {
                    m.listClass = "list", m.searchClass = "search", m.sortClass = "sort", m.page = 1e4, m.i = 1, m.items = [], m.visibleItems = [], m.matchingItems = [], m.searched = !1, m.filtered = !1, m.searchColumns = void 0, m.handlers = {updated: []}, m.valueNames = [], m.utils = {
                        getByClass: i,
                        extend: a,
                        indexOf: s,
                        events: o,
        ...
        var r = n(0), i = n(1), a = n(11);
        t.exports = function (t) {
            var e = function (e, i) {
                var a, o = t.matchingItems.length, l = t.i, u = t.page, c = Math.ceil(o / u), f = Math.ceil(l / u),
                    d = i.innerWindow || 2, h = i.left || i.outerWindow || 0, m = i.right || i.outerWindow || 0;
                m = c - m, e.clear();
                for (var v = 1; v <= c; v++) {
                    var g = f === v ? "active" : "";
        ...
        t.exports = function (t) {
            var e, n, r, i, a = {
                ...
                list: function () {
                    ...
                    t.found = !1;
                    for (var e = 0, r = n.length; e < r; e++) if (s.values(t.values(), n[e])) return void(t.found = !0)
                }, values: function (n, i) {
        ...
        t.exports = function (t) {
            var e = {
                ...
                t.trigger("sortStart");
                var n = {}, r = arguments[0].currentTarget || arguments[0].srcElement || void 0;
                ...
                var i, a = n.sortFunction || t.sortFunction || null, s = "desc" === n.order ? -1 : 1;
                i = a ? function (t, e) {
                    return a(t, e, n) * s
                } : function (e, r) {
        ...
        var n = function (t) {
            ...
            this.clearSourceItem = function (e, n) {
                for (var r = 0, i = n.length; r < i; r++) {
                    var a;
                    if (n[r].data) for (var s = 0, o = n[r].data.length; s < o; s++) e.setAttribute("data-" + n[r].data[s], ""); else n[r].attr && n[r].name ? (a = t.utils.getByClass(e, n[r].name, !0)) && a.setAttribute(n[r].attr, "") : (a = t.utils.getByClass(e, n[r], !0)) && (a.innerHTML = "");
                    a = void 0
                }
                return e
            }, this.getItemSource = function (e) {
                if (void 0 === e) {
                    for (var n = t.list.childNodes, r = 0, i = n.length; r < i; r++) if (void 0 === n[r].data) return n[r].cloneNode(!0)
                } else {
                    if (/<tr[\s>]/g.exec(e)) {
                ...
                for (var i = {}, a = 0, s = r.length; a < s; a++) {
                    var o;
                    if (r[a].data) for (var l = 0, u = r[a].data.length; l < u; l++) i[r[a].data[l]] = t.utils.getAttribute(e.elm, "data-" + r[a].data[l]); else r[a].attr && r[a].name ? (o = t.utils.getByClass(e.elm, r[a].name, !0), i[r[a].name] = o ? t.utils.getAttribute(o, r[a].attr) : "") : (o = t.utils.getByClass(e.elm, r[a], !0), i[r[a]] = o ? o.innerHTML : "");
                    o = void 0
                }
                return i
            }, this.set = function (e, r) {
                var i = function (e) {
                    for (var n = 0, r = t.valueNames.length; n < r; n++) if (t.valueNames[n].data) {
                        for (var i = t.valueNames[n].data, a = 0, s = i.length; a < s; a++) if (i[a] === e) return {data: e}
                    } else {
                        if (t.valueNames[n].attr && t.valueNames[n].name && t.valueNames[n].name == e) return t.valueNames[n];
                        if (t.valueNames[n] === e) return e
                    }
                };
                if (!n.create(e)) for (var a in r) r.hasOwnProperty(a) && function (n, r) {
                    var a, s = i(n);
        ...
        t.exports = function (t, e) {
            ...
            if (!n) for (var r = t.attributes, i = r.length, a = 0; a < i; a++) void 0 !== e[a] && e[a].nodeName === e && (n = e[a].nodeValue);
            return n
        }
    }, function (t, e, n) {
        function r(t) {
        ...
        function i(t, e) {
            for (var n = (t += "").length, i = (e += "").length, a = 0, l = 0; a < n && l < i;) {
                var u = t.charCodeAt(a), c = e.charCodeAt(l);
                if (r(u)) {
                    if (!r(c)) return u - c;
        ...
        t.exports = function (t, e, n) {
            function r(t, n) {
                var r = t / e.length, i = Math.abs(o - n);
                return a ? r + i / a : i ? 1 : r
            }

            var i = n.location || 0, a = n.distance || 100, s = n.threshold || .4;
            if (e === t) return !0;
            ...
            -1 != c && (u = Math.min(r(0, c), u), -1 != (c = t.lastIndexOf(e, o + e.length)) && (u = Math.min(r(0, c), u)));
            var f = 1 << e.length - 1;
            c = -1;
            for (var d, h, m, v = e.length + t.length, g = 0; g < e.length; g++) {
                for (d = 0, h = v; d < h;) r(g, o + h) <= u ? d = h : v = h, h = Math.floor((v - d) / 2 + d);
                v = h;
                var p = Math.max(1, o - h + 1), y = Math.min(o + h, t.length) + e.length, b = Array(y + 2);
                b[y + 1] = (1 << g) - 1;
                for (var C = y; C >= p; C--) {
        ...
        }], fuzzySearch: {searchClass: "search", location: 0, distance: 20, threshold: .4, multiSearch: !0}
    }, recipeList = new List("js-list", searchOptions), checkCategory = document.getElementsByClassName("js-category"),
    checkDuration = document.getElementsByClassName("js-duration"),
    checkMeat = document.getElementsByClassName("js-meat"), checkOrigin = document.getElementsByClassName("js-origin"),
